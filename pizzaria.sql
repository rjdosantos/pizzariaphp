...
CREATE TABLE IF NOT EXISTS `pizzaria`.`borda` (
  `idborda` INT NOT NULL AUTO_INCREMENT,
  `tipo_borda` VARCHAR(45) NULL,
  PRIMARY KEY (`idborda`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`massa` (
  `idmassa` INT NOT NULL AUTO_INCREMENT,
  `tipo_massa` VARCHAR(45) NULL,
  PRIMARY KEY (`idmassa`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pizzaria`.`pizza` (
  ...
  PRIMARY KEY (`idpizza`),
  INDEX `borda_id` (`borda_id` ASC) VISIBLE,
  INDEX `massa_id` (`massa_id` ASC) VISIBLE,
  CONSTRAINT `borda_id`
